...
public class MoreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ConstraintLayout emergencyContactButton = inflate.findViewById(R.id.emergencyContactButton);
        emergencyContactButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity().getApplicationContext(),EmergencyContact.class);
